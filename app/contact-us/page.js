                    ...
                    <div className="flex-1 mt-12 sm:max-w-lg lg:max-w-md">
                        ...
                        >
                            ...
                            <div>
                                ...
                                <textarea required className="w-full mt-2 h-36 px-3 py-2 resize-none appearance-none bg-transparent outline-none border focus:bg-primary-dark shadow-sm rounded-lg"></textarea>
                            </div>
                            <button
                                className="w-full px-4 py-2 text-white font-medium bg-primary hover:bg-primary-light active:bg-primary-dark rounded-lg duration-150"
                            >
                                Submit
                            </button>
                        </form>
